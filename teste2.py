...
if escolha < 2:
    ...
    if Banho == 1:
        print("O nosso banho e feito com Shampoo e Condicionador, com o maximo de cuidado possivel com o seu gato(a),\n"
              "colocamos algodão no ouvido dele(a) para não entrar agua, a nossa agua é morna ( não tão quente e não tão\n "
              "fria ), e ao final do banho secamos ele com secador de cabelo em temperatura ambiente e tambem penteamos ele\n "
              "para ficar lindo esperando você, caso você queira podemos colocar lacinhos nele(a). ")
    else:
        print("Ok")
    ...
    if Higiene == 2:
        print(
            ...
            " pet,\n"
            "cortamos a unha e lichamos para não ficar arranhando e ficar linda.")
    else:
        print("Ok")
...
if escolha > 1:
    ...
    if Banho == 1:
        print(
            "O nosso banho e feito com Shampoo e Condicionador, com o maximo de cuidado possivel com o seu cachorro(a),\n"
            "colocamos algodão no ouvido dele(a) para não entrar agua, a nossa agua é morna ( não tão quente e não tão\n "
            "fria ), e ao final do banho secamos ele com secador de cabelo em temperatura ambiente e tambem penteamos ele\n "
            "para ficar lindo esperando você, se você quiser tambem podemos tosar ele caso você queira podemos colocar,\n"
            " lacinhos nele(a). ")
    else:
        print("Ok")
    ...
    if Higiene == 1:
        print(
            "Nos limpamos o ouvido do seu Cachorro(a) com cotonetes e com todo o cuidado do mundo para não machucar o seu\n"
            " pet,\n"
            "cortamos a unha e lichamos para não ficar arranhando.")
    else:
        print("Ok")
